...
class Solicitudes extends Model
{
    ...
    public function nuevo($solicitud_folio, $id_estatus, $id_area, $id_persona, $id_motivo, 
    $id_concepto, $solicitud_descripcion, $solicitud_fecha, $solicitud_costo_estimado, 
    $solicitud_costo_autorizado, $solicitud_costo_diferencia)
    {
        ...
        $nuevo->solicitud_fecha = $solicitud_fecha;
